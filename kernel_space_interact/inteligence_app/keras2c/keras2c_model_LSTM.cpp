...
void LSTMModel::keras2c_model_Round_POC_500Mbps(const k2c_tensor* input_layer_14_input, k2c_tensor* keras_tensor_9_output) 
{ 
	
	
	cout << "LSTM_ACK_SND_RTT_Round_POC_500Mbps" << endl;
